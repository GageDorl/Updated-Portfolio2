  ...
  return (
    <Container fluid>
      ...
      <div style={{textAlign:"center"}}>
        <img src={process.env.PUBLIC_URL+"/assets/images/insta.png"} alt="Insta" className="icon" onClick={()=>window.location.assign("https://instagram.com/gagedorl")}/>
        <img src={process.env.PUBLIC_URL+"/assets/images/linkedin.png"} alt="linkedin" className="icon" onClick={()=>window.location.assign("https://linkedin.com/in/gage-d-orlando-392b61186")} />
        <img src={process.env.PUBLIC_URL+"/assets/images/github.png"} alt="Github" className="icon" onClick={()=>window.location.assign("https://github.com/gagedorl")} />
      </div>
    </Container>
  );
}
