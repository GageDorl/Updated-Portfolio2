...
let slides = [
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/clicky.png"} alt="1" />,
    title:"Clicky Game",
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/chemconnect.png"} alt="2" />,
    title:"Chem Connect",
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/burger.png"} alt="3" />,
    title:"Burger-Vore",
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/friend_finder.png"} alt="4" />,
    title:"Friend Finder",
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/fudge-it-budget.png"} alt="5" />,
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/giphything.png"} alt="6" />,
    title:"Giphy Thing",
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/Hangman-Again.png"} alt="7" />,
    title:"Hangman (Again)",
  ...
  {
    key: uuidv4(),
    content: <img src={"../../pages/images/liri.png"} alt="8" />,
    title:"LIRI",
  ...
  {
      key:uuidv4(),
      content: <img src={"../../pages/images/RPS.png"} alt="9"/>,
  ...
  {
    key:uuidv4(),
    content: <img src={"../../pages/images/trivia.png"} alt="10"/>,
    title:"Trivia Games",
  ...
  {
    key:uuidv4(),
    content: <img src={"../../pages/images/unit-4.png"} alt="11"/>,
    title:"Unit-4",
  ...
  {
    key:uuidv4(),
    content: <img src={"../../pages/images/word_guess.png"} alt="12"/>,
 ...
 {
    key:uuidv4(),
    content:<img src={"../../pages/images/highschool.png"} alt="13" />,
